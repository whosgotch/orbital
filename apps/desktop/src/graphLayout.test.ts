...
function node(id: string, kind: WorkspaceGraphNode["kind"], missionId?: string): WorkspaceGraphNode {
  return { id, kind, label: id, detail: "", mission_id: missionId, repository_id: "r1" };
}
