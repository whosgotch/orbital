...
func (w *LocalCommandWorker) Profile() WorkerProfile {
	return WorkerProfile{
		...
		Limitations: []string{
			"does not parse patch artifacts yet",
...
func (w *LocalCommandWorker) StartRun(ctx context.Context, request RunRequest) (<-chan RunEvent, error) {
	...
	go func() {
		...
		output, err := w.runCommand(ctx, request)
		if err != nil {
...
func (w *LocalCommandWorker) runCommand(ctx context.Context, request RunRequest) (string, error) {
